...
model_parameters='models/parameters/srl/srl_params_pass'


# word vector
word_vector_values = srl_data.get_embedding()



word_dict, verb_dict, label_dict = srl_data.get_dict()
...
def main():
    ...
    # chunk_types=label_dict_len/2
    # chunk_evaluator(
    # name="chunk_f1",
    # input=crf_dec,
    # label=target,
    # chunk_scheme="IOB",
    # num_chunk_types=chunk_types)
    ...
    train_reader = paddle.batch(
        srl_data.shuffle(srl_data.train(), buf_size=buf_size), batch_size=batch_size)

    test_reader = paddle.batch(
        srl_data.shuffle(srl_data.test(), buf_size=buf_size), batch_size=batch_size)
